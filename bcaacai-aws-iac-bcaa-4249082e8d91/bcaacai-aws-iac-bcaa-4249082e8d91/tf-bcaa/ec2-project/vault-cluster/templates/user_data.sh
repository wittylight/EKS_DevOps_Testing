...
# Disbale TLS
sed -i "/tls_cert_file/d" /opt/vault/config/default.hcl
sed -i "/tls_key_file/c\  tls_disable = 1" /opt/vault/config/default.hcl
sed -i "s/https/http/g" /opt/vault/config/default.hcl
